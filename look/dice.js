...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-c7d8dc6e');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-c7d8dc6e');}
...
function clearFlash(){dieView.classList.remove('rl-win-c7d8dc6e');dieView.classList.remove('rl-lose-c7d8dc6e');if(frameEl){frameEl.classList.remove('rl-win-c7d8dc6e');frameEl.classList.remove('rl-lose-c7d8dc6e');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-c7d8dc6e');if(frameEl){frameEl.classList.add('rl-win-c7d8dc6e');}}else{dieView.classList.add('rl-lose-c7d8dc6e');if(frameEl){frameEl.classList.add('rl-lose-c7d8dc6e');}}
...
var brandEl=document.querySelector('.rl-brand-c7d8dc6e');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
